...
const Keto = () => {
	...
	return (
		<InputForm
			...
			netCarbs={netCarbs}
			setNetCarbs={setNetCarbs}
			calorieAdjustment={calorieAdjustment}
			setCalorieAdjustment={setCalorieAdjustment}
		/>
	);
};
	...
	return (
		<form>
			...
			<InputFormNumberField
				...
				value={weight}
				updateValue={setWeight}
			/>
			<InputFormNumberField
				fieldId='bodyfat'
				title='Vetpercentage (%)'
				value={bodyfat}
				updateValue={setBodyfat}
			/>
			<InputFormNumberField
				fieldId='height'
				title='Lengte (cm)'
			...
			<InputFormNumberField
				...
				value={activityLevel}
				updateValue={setActivityLevel}
			/>
			<InputSlider
				value={activityLevel}
				updateValue={setActivityLevel}></InputSlider>
			<InputFormNumberField
				fieldId='netCarbs'
				title='Netto Koolhydraten(g)'
				value={netCarbs}
				updateValue={setNetCarbs}
			/>
			...
			<InputFormNumberField
				...
				updateValue={setCalorieAdjustment}
			/>
		</form>
	);
};
...
const InputFormNumberField = ({ props, value, updateValue }) => {
	function toNumber(value) {
		return isNaN(value) || value === undefined ? 0 : value;
	}

	const [thevalue, setValue] = [value, updateValue];
